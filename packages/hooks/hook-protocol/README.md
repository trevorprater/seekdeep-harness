...
| Concern | Here (`seekdeep-hook-protocol`) | The bridge (`seekdeep-hooks-claude-code` / `-codex`) |
|---|---|---|
...
Indirectly, through `seekdeep-hooks-claude-code` and `seekdeep-hooks-codex`, which can turn parsed hook output into prompt context, blocked outcomes, or continuation feedback.
