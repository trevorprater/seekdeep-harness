# @seekdeep-ai/seekdeep-goal-round-driver
...
- id: tool-goal
  name: '@seekdeep-ai/seekdeep-tool-goal'

- id: goal-round-driver
  name: '@seekdeep-ai/seekdeep-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`seekdeep-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
