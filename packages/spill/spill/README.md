...
| Package | Role |
|---|---|
| `@seekdeep-ai/seekdeep-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@seekdeep-ai/seekdeep-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@seekdeep-ai/seekdeep-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
