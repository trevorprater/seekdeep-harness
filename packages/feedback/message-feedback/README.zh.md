...
公开的请求、值、版本与失败类型从包根入口及 `@seekdeep-ai/seekdeep-message-feedback/types` 导出；其源码为 [`src/types.ts`](https://github.com/fugue-labs/deepseek-harness/blob/37200a934324dd7167ec8a8d3ac1fd01e2239909/packages/feedback/message-feedback/src/types.ts)。
...
```yaml
- id: message-feedback
  name: '@seekdeep-ai/seekdeep-message-feedback'
  config:
    maxNoteBytes: 8192
```
