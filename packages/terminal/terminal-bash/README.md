...
The policy owner contributes capability-neutral `sandbox:policy` context. Through `@seekdeep-ai/seekdeep-tool-terminal` or another PTY consumer, the model may also receive bounded MOTD, send deltas, scrollback pages, readiness reasons, and cleanup errors.
