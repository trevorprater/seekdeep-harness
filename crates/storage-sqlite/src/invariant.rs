//! Package-owned `SQLite` invariant registration.
...
pub const INVARIANT_NAME: &str = "storage-sqlite-invariant";
const PACKAGE_NAME: &str = "@deepseek-ai/seekdeep-storage-sqlite";
