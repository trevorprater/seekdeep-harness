//! Package-owned invariant companion for `seekdeep-command-compact`.
...
pub const PACKAGE_NAME: &str = "@deepseek-ai/seekdeep-command-compact";

/// Cordis companion plugin name.
pub const NAME: &str = "command-compact-invariant";
...
/// expected failures are classified by the compaction domain, so the runtime
