//! Package-owned invariant companion for `seekdeep-web-search-deepseek`.
...
pub const PACKAGE_NAME: &str = "@deepseek-ai/seekdeep-web-search-deepseek";

/// Cordis companion plugin name.
pub const NAME: &str = "web-search-deepseek-invariant";
