//! Shared test fixtures for the web-search-deepseek parity suites.
...
use seekdeep_settings::{SettingsDocument, SettingsNamespace, SettingsStorage};
...
/// An in-memory settings storage for section-layering tests.
pub struct MemorySettings {
    doc: Mutex<SettingsDocument>,
}

impl MemorySettings {
    /// Builds an empty writable storage.
    #[must_use]
    pub fn new() -> Arc<Self> {
        Arc::new(Self {
            doc: Mutex::new(SettingsDocument::new()),
        })
    }
}
