...
export function makeWorkspacePickerBench(){
  ...
  cached={React,primitives:{Button:primitive('Button'),HoverCard:primitive('HoverCard'),IconArchiveOutline20:primitive('IconArchiveOutline20'),IconBranchOutline16:primitive('IconBranchOutline16'),IconEditOutline16:primitive('IconEditOutline16'),IconEllipsisOutline16:primitive('IconEllipsisOutline16'),IconFolderClose16:primitive('IconFolderClose16'),IconFolderOpen16:primitive('IconFolderOpen16'),IconPlusOutline16:primitive('IconPlusOutline16'),IconTrashOutline16:primitive('IconTrashOutline16'),IconTriangleRightFill14:primitive('IconTriangleRightFill14'),Menu:primitive('Menu'),Modal:primitive('Modal'),StateDot:primitive('StateDot')},t:key=>copy[key]??key,render(component,props){si=0;ei=0;mi=0;return resolve(React.createElement(component,props))},reset(){for(const effect of effects.reverse())effect?.cleanup?.();states.length=0;effects.length=0;memos.length=0}}
  return cached
}
