//! Package-owned invariant companion for seekdeep-agent-instructions.
...
pub const PACKAGE_NAME: &str = "@deepseek-ai/seekdeep-agent-instructions";

/// Cordis companion plugin name.
pub const NAME: &str = "workspace-context-invariant";
