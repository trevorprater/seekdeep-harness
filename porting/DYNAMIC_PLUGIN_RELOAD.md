...
- Browser service access and callback binding share a Rust/WASM tracer with source tracker, shadow, receiver, and immediate-return semantics. Source comparison and Chromium verify listener-owned effect cleanup; specialized per-Fiber `internal/update` routing remains open.
