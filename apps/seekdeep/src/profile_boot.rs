...
pub fn register_compiled_profile_plugins(catalog: &PluginCatalog) -> anyhow::Result<()> {
    for (name, plugin) in vec![
        ...
        (
            "seekdeep-client-ui-commands",
            seekdeep_client_ui_commands::host_plugin(),
        ),
        (
        ...
        (
            "seekdeep-client-ui-goal",
            seekdeep_client_ui_goal::host_plugin(),
        ),
        (
        ...
        (
            "seekdeep-client-ui-permission-presets",
        ...
        (
            "seekdeep-client-ui-user-questions",
            seekdeep_client_ui_user_questions::host_plugin(),
        ),
        (
        ...
        (
            "seekdeep-client-ui-settings-plugins",
            seekdeep_client_ui_settings_plugins::host_plugin(),
        ),
        (
        ...
        (
            "seekdeep-client-ui-workspace",
            seekdeep_client_ui_workspace::host_plugin(),
        ),
        (
