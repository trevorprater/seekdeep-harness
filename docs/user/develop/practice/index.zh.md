...
- **Service Definition** (`seekdeep-shell`)：定义 Cordis 服务以及 Bash 请求和结果类型
- **Service Provider** (`seekdeep-bash-local`)：在本地计算机上执行命令
- **Consumer** (`seekdeep-tool-bash`)：将该能力公开为模型可调用的工具
