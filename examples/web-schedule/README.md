...
This overlay opts one `seekdeep web` process into Schedule reminders without changing the shipped default Web composition:

```sh
seekdeep web --patch examples/web-schedule/cordis.yml
```
