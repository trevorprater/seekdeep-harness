...
SeekDeep Harness is licensed under [MIT](LICENSE). It depends on the third-party software listed below. Each project remains under its own license; nothing in this file changes those terms.
...
The Cordis framework and its foundation libraries are source-vendored into this repository rather than consumed from npm, and republished under the `@seekdeep-ai` scope. All are MIT-licensed; each directory preserves its upstream `LICENSE` file. Exact upstream commits and local modifications are recorded in [`vendor/README.md`](vendor/README.md).

| Package | Upstream name | Upstream | License |
| --- | --- | --- | --- |
| `@seekdeep-ai/cosmokit` | `cosmokit` | [github.com/seekdeep-harness/cosmokit](https://github.com/seekdeep-harness/cosmokit) | MIT |
| `@seekdeep-ai/schemastery` | `schemastery` | [github.com/seekdeep-harness/schemastery](https://github.com/seekdeep-harness/schemastery) | MIT |
| `@seekdeep-ai/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/seekdeep-harness/cordis](https://github.com/seekdeep-harness/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/seekdeep-harness/cordis](https://github.com/seekdeep-harness/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/seekdeep-harness/cordis](https://github.com/seekdeep-harness/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/seekdeep-harness/cordis](https://github.com/seekdeep-harness/cordis) | MIT |
| `@seekdeep-ai/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/seekdeep-harness/cordis](https://github.com/seekdeep-harness/cordis) | MIT |

## Runtime npm dependencies

External packages that a workspace package resolves at runtime. The tier covers every plugin a user can mount from `cordis.yml` — not only what the `seekdeep` CLI, Web UI, and Python SDK runtime load by default.
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any SeekDeep Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `seekdeep-harness-sdk` |
...
`@seekdeep-ai/node-addon-landlock-run` (and its platform packages) is built and released from this repository under BSD 3-Clause. It is listed here for completeness; it is first-party, not third-party.
